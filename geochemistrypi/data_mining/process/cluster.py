...
from ..model.clustering import AggClustering, ClusteringWorkflowBase, DBSCANClustering, KMeansClustering
...
class ClusteringModelSelection(ModelSelectionBase):
    ...
    def activate(
        ...
        if self.model_name == "KMeans":
            ...
            hyper_parameters = AggClustering.manual_hyper_parameters()
            self.clt_workflow = AggClustering(
                n_clusters=hyper_parameters["n_clusters"],
