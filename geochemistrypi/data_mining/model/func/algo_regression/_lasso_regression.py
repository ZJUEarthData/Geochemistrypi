...
from ....data.data_readiness import float_input, str_input
...
def lasso_regression_manual_hyper_parameters() -> Dict:
    ...
    print("Please indicate the coefficient of alpha. A good starting range could be between 0.001 and 2, such as 0.01.")
    alpha = float_input(0.01, SECTION[2], "@Alpha: ")
    print("fit_intercept: This hyperparameter represents whether the model is evaluated with constant terms.")
    ...
    print("Please specify whether to include a bias term in the model. It is generally recommended to leave it set to False.")
    normalizes = ["True", "False"]
    normalize = bool(str_input(normalizes, SECTION[2]))
    hyper_parameters = {"alpha": alpha, "fit_intercept": fit_intercept, "normalize": normalize}
