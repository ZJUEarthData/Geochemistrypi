...
def elasticNet_regression_manual_hyper_parameters() -> Dict:
    ...
    print("Please indicate the coefficient of alpha. It is generally recommended to leave it set to 1.")
    ...
    print("Please indicate the l1_ratio. A good starting range could be between 0 and 1, such as 0.5.")
    l1_ratio = float_input(0.01, SECTION[2], "@L1_ratio: ")
