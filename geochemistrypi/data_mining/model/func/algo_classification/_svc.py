...
def svc_manual_hyper_parameters() -> Dict:
    ...
    #     print("The coef0 parameter controls the influence of higher-order terms in the polynomial and sigmoid kernels, and it can help to adjust the balance between the linear and nonlinear parts"
