...
def logistic_regression_manual_hyper_parameters() -> Dict:
    ...
    print("Class Weight: This hyperparameter specifies the weights associated with classes. It can be set to 'balanced' to automatically adjust the weights inversely proportional to the class frequencies in the input data.")
    ...
    hyper_parameters = {'penalty': penalty, 'C': C, 'solver': solver, 'max_iter': max_iter, 'class_weight': class_weight, 'l1_ratio': l1_ratio}
