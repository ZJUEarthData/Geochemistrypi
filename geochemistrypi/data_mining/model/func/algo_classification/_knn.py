...
def knn_manual_hyper_parameters() -> Dict:
    ...
    print(
        "Please specify the number of neighbors to use by default for kneighbors queries. A good starting range could be between 1 and"
    ...
    print("Please specify the weight function used in prediction. It is generally recommended to leave it set to uniform.")
    weights = ["uniform", "distance"]
    weight = str_input(weights, SECTION[2])
    print("Algorithm: Algorithm used to compute the nearest neighbors.")
    print("Please specify the algorithm used to compute the nearest neighbors. It is generally recommended to leave it set to auto.")
    ...
    if algorithm in ["ball_tree", "kd_tree"]:
        ...
        print("Please specify the leaf size passed to BallTree or KDTree. A good starting range could be between 10 and 100, such as 30.")
        leaf_size = num_input(SECTION[2], "@Leaf Size: ")
    print("Metric: The distance metric to use for distance computation.")
    print("Please specify the distance metric to use for the tree. It is generally recommended to leave it set to minkowski.")
    metrics = ["euclidean", "manhattan", "minkowski"]
    metric = str_input(metrics, SECTION[2])
    p = None
    if metric == "minkowski":
        print("P: Power parameter for the Minkowski metric.")
        print("Please specify the power parameter for the Minkowski metric. A good starting range could be between 1 and 5, such as 2.")
