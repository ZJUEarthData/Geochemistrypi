"""Versioned clustering choices exposed by the GeochemistryPi 0.8.2 CLI."""
...
UNSUPPORTED_INTERACTIONS: Final[tuple[str, ...]] = (
    ...
    "clustering.keep_missing_values: GeochemistryPi 0.8.2 exposes no clustering model when missing values remain unprocessed",
    "clustering.optics: an internal implementation exists but OPTICS is not present in the public 0.8.2 CLI model menu",
