"""Versioned anomaly-detection choices exposed by GeochemistryPi 0.8.2."""
...
UNSUPPORTED_INTERACTIONS: Final[tuple[str, ...]] = (
    ...
    "anomaly_detection.keep_missing_values: GeochemistryPi 0.8.2 exposes no anomaly-detection model when missing values remain unprocessed",
