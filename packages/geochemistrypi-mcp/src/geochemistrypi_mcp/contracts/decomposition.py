"""Versioned decomposition choices exposed by the GeochemistryPi 0.8.2 CLI."""
...
UNSUPPORTED_INTERACTIONS: Final[tuple[str, ...]] = (
    ...
    "decomposition.keep_missing_values: GeochemistryPi 0.8.2 exposes no decomposition model when missing values remain unprocessed",
