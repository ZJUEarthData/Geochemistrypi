...
def elements_ratio_map(col1, col2, df):
    ...
    plt.savefig(r'C:\Users\dell\Desktop\Edge\map.png')
    plt.show()
    
    
col1 = input("Please enter the Element 1：")
col2 = input("Please enter the Element 1：")
df = input("Please enter the data set：")
elements_ratio_map(col1, col2, df)